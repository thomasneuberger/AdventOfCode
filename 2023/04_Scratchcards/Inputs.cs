...
public static class Inputs
{
    ...
    private static Card ParseLine(string line)
    {
        ...
        var winningNumbers = numberParts[0].Split(' ', StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToDictionary(n => n, n => n);
        var yourNumbers = numberParts[1].Split(' ', StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray(); 
